...
import server.util.ClientUtility;
...
public class Registration extends HttpServlet {
	...
	RegistrationBeanRemote registration;

	@EJB(name = "registration")
	public void setRegistration(RegistrationBeanRemote registration) {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if (action.equals("login")) {
			...
			Customer customer = registration.validateLogin(username, password);
